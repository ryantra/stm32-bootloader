...
> **Status: in progress.** The build system, memory map, protocol, and host tool are in
> place; the bootloader firmware logic is being implemented milestone by milestone (see
> below). Files with `TODO` are the parts under active development.
...
- [ ] M1 — App links at `0x08008000`; bootloader jumps to it (VTOR relocation working)
